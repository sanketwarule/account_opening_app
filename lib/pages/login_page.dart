...
import 'package:account_opening_app/widgets/BaseWidget.dart';
...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      BaseWidget<NetworkBloc, NetworkState>(
...
//      },
      ...
      child: BlocProvider(
        ...
        builder: (BuildContext context) => LoginBloc(userRepository: UserRepository()),
